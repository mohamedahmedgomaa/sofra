    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">{{trans('admin.listContacts')}}</h3>
                                                ...
                                                @foreach($records as $record)
                                                    <tr id="removable{{$record->id}}">
                                                        ...
                                                        @if($record->type == 'complaint')
                                                            <td class="alert alert-danger text-center">شكوى</td>
                                                        @elseif($record->type == 'suggestion')
                                                            <td class="alert alert-success text-center">اقتراح</td>
                                                        @else
                                                            <td class="alert alert-info text-center">استعلام</td>
                                                        @endif

...
@section('content')
    ...
    <section class="register add-offer">
        ...
        <div class="form-section">
            <form class="pt-2" method="post" action="{{url(route('restaurant.postEditOffer',$model->id))}}" enctype="multipart/form-data">
                {!! csrf_field() !!}
                ...
                <div class="form-group">
                    <div class="image-upload mb-2">
                        ...
                        <input id="file-input" type="file" name="image" value="{{$model->image}}">
                    </div>
                    <h4 style="color: #230040;margin-bottom: 2rem">صورة العرض</h4>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" name="name" value="{{$model->name}}" id="exampleInputText1" aria-describedby="emailHelp"
                           placeholder="اسم العرض">
                </div>
                <div class="form-group">
                    <textarea rows="5" class="form-control" name="content" id="exampleInputText1" aria-describedby="emailHelp"
                              placeholder="وصف مختصر">{{$model->content}}</textarea>
                </div>
                {{--                <div class="form-group">--}}
                ...
                <div class="form-row">
                    ...
                    <input type="text" name="from" value="{{$model->from}}" id="demo-3_1" class="form-control-sm px-1">
                    <h6 style="color: #230040;align-self: center;" class="px-2">إلى</h6>
                    <input type="text" name="to" value="{{$model->to}}" id="demo-3_2" class="form-control-sm px-1">
                </div>

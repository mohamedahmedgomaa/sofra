    ...
    <main class="register-bg">
        <section class="register">
            <div class="form-section">
                ...
                <form class="pt-3" method="post" action="{{url(route('post.register.restaurant'))}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}

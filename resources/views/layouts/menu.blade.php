...
<ul class="sidebar-menu" data-widget="tree">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="{{url('/admin/home')}}"><i class="fa fa-circle-o"></i>{{trans('admin.dashboard')}} </a></li>
...
{{--    @if(auth()->user()->hasRole('laravel'))--}}
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li><a href="{{url(route('user.index'))}}"><i class="fa fa-user"></i> {{trans('admin.users')}}</a></li>
